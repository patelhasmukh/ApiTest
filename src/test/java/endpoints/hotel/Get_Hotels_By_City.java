...
public class Get_Hotels_By_City extends BaseSetup {
	 ...
	 */
	@Parameters("city_id")
	public void getHotelByCity_verifyStatusCode200(String city_id) {
	...
	@Test(dependsOnMethods = { "getHotelByCity_verifyStatusCode200" })
	/* 
	...
	public void getHotelByCity_verifyResponseSLA(String city_id, int responseTime) {
		Map<String, String> parametersMap = new HashMap<String, String>();
		parametersMap.put("city_id", city_id);
		RequestSpecification request = getRestRequestSpecification();
